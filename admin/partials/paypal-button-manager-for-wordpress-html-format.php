 ...
 * @version	1.0.0
 * @package		paypal-button-manager-for-wordpress/partials
 * @category	Class
...
class AngellEYE_PayPal_Button_Manager_for_WordPress_button_interface {
    ...
    public function paypal_button_manager_button_interface_html() {
        ?>
        <div id="wrap">
                                ...
                                <div class="accordionContainer">
                                    <div class="accordion dynamic">
                                        ...
                                        <div id="stepOne" class="box top defaultOpen open">
                                            <div class="header">
                                                <h3>Step 1: Choose a button type and enter your payment details</h3>
                                            </div>
        ...
        <?php } ?>
                                                        ...
                                                        <div class="group details">
                                                            ...
                                                            <div class="donations accessAid fadedOut">
                                                                ...
                                                                <div class="floatLeft"><label for="donationID">Donation ID<span class="fieldNote"> (optional) </span><span class="autoTooltip" title="" tabindex="0">What's this?<span class="accessAid">You can assign an Item ID as a unique identifier to make tracking easier</span></span></label><input class="text" maxlength="127" type="text" id="donationID" size="27" name="donation_id" value="" disabled=""></div>
                                                            </div>
                                                            <div class="subscriptions accessAid fadedOut">
                                                                ...
                                                                <div class="floatLeft"><label for="subscriptionID">Subscription ID<span class="fieldNote"> (optional) </span><span class="autoTooltip" title="" tabindex="0">What's this?<span class="accessAid">You can assign an Item ID as a unique identifier to make tracking easier</span></span></label><input class="text" maxlength="127" type="text" id="subscriptionID" size="27" name="subscription_id" value="" disabled=""></div>
                                                            </div>
        ...
        <?php } ?>
                                                            ...
                                                            <div class="group">
                                                                ...
                                                                <div class="trialOfferOptions accessAid">
                                                                    <fieldset>
                                                                        <legend>Amount to bill for the trial period<span class="autoTooltip" title="" tabindex="0">What's this?<span class="accessAid">Customers will receive just one bill for each trial period.</span></span></legend>
        ...
        <?php } ?>
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="secondTrialOfferOptions accessAid">
                                                                            <fieldset>
                                                                                <legend>Amount to bill for this trial period<span class="autoTooltip" title="" tabindex="0">What's this?<span class="accessAid">Customers will receive one bill for the entire trial period.</span></span></legend>
        ...
        <?php } ?>
                                                        ...
                                                        <div class="group notifications">
                                                            <fieldset>
                                                                <legend>Merchant account IDs <a target="_blank" class="infoLink" href="https://www.paypal.com/businessstaticpage/BDMerchantIdInformation" onclick="PAYPAL.core.openWindow(event,{height:500, width: 450});">Learn more</a></legend>
                                                                <label for="merchantIDNotificationMethod"><input class="radio" type="radio" id="merchantIDNotificationMethod" checked="" name="payment_notification_method" value="merchantid">Use my secure merchant account ID</label><label for="emailNotificationMethod"><input class="radio" type="radio" id="emailNotificationMethod" name="payment_notification_method" value="email">Use my primary email address pay.multidots@gmail.com<input type="hidden" name="payment_notification_email_address" value="pay.multidots@gmail.com"></label>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="stepThree" class="box last">
                                            <div class="header">
                                                <h3>Step 3: Customize advanced features (optional)</h3>
                                            </div>
                                            <div class="body">
                                                <div class="content">
                                                    <div class="container">
                                                        ...
                                                        <div id="addVariablesContainer" class="opened">
                                                            ...
                                                            <div id="variablesTextareaContainer">
                                                                ...
                                                                <div id="variablesExamples"><span class="header">Example</span><br>address_override=1<br>notify_url=https://www.mywebsite.com/PayPal_IPN</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script type="text/javascript" src="<? echo site_url(); ?>/wp-content/plugins/paypal-button-manager-for-wordpress/admin/paypal_files/paypal-button-manager-for-wordpress-buttonDesigner.js"></script>
...
AngellEYE_PayPal_Button_Manager_for_WordPress_button_interface::init();