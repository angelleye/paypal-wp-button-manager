 ...
 */
class AngellEYE_PayPal_Button_Manager_for_WordPress {
     ...
     * @since    1.0.0
     * @access   protected
     * @var      AngellEYE_PayPal_Button_Manager_for_WordPress_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - AngellEYE_PayPal_Button_Manager_for_WordPress_Loader. Orchestrates the hooks of the plugin.
     * - AngellEYE_PayPal_Button_Manager_for_WordPress_i18n. Defines internationalization functionality.
     * - AngellEYE_PayPal_Button_Manager_for_WordPress_Admin. Defines all hooks for the dashboard.
     * - AngellEYE_PayPal_Button_Manager_for_WordPress_Public. Defines all hooks for the public side of the site.
     *
    ...
    private function load_dependencies() {
         ...
         * of the plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-paypal-button-manager-for-wordpress-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the Dashboard.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-paypal-button-manager-for-wordpress-admin.php';
     ...
     *
     * Uses the AngellEYE_PayPal_Button_Manager_for_WordPress_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    private function set_locale() {
        ...
        $plugin_i18n = new AngellEYE_PayPal_Button_Manager_for_WordPress_i18n();
    ...
    private function define_admin_hooks() {
        ...
        $plugin_admin = new AngellEYE_PayPal_Button_Manager_for_WordPress_Admin($this->get_plugin_name(), $this->get_version());

        $this->loader->add_action('admin_enqueue_scripts', $plugin_admin, 'enqueue_styles');
        $this->loader->add_action('admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts');
        $this->loader->add_action('admin_notices', $plugin_admin, 'paypal_button_manager_for_wordpress_notice_display');
        $this->loader->add_filter('post_updated_messages', $plugin_admin, 'paypal_button_manager_for_wordpress_success_notice_display');
    }
     ...
     *
     * @since     1.0.0
     * @return    AngellEYE_PayPal_Button_Manager_for_WordPress_Loader    Orchestrates the hooks of the plugin.
     */
