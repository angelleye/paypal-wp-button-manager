...
jQuery(function () {
    ...
    // Push notices rendered by AngellEYE_Push_Notifications are dismissed by that
    // class's own handler (printed once via admin_print_footer_scripts). Here we
    // only fade them in — display:none is applied server-side.
