        ...
        <div class="paypal-wp-manager-left">
            <div class="paypal-wp-l-logo-details">
                ...
                <div class="paypal-wp-l-details">
                	<a class="paypal-add-company button" href="<?php echo admin_url('admin.php?page=' . self::$paypal_button_company_slug . '&type=new'); ?>"><?php _e('Add Account','angelleye-paypal-wp-button-manager'); ?></a>
                </div>
            </div>
