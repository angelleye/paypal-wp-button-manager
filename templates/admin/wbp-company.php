        ...
        <div class="paypal-wp-manager-left">
            <div class="paypal-wp-l-logo-details">
                ...
                <div class="paypal-wp-l-details">
                    <div class="paypal-ac-heading"><?php _e('Welcome To The Most PayPal WP Button Manager','paypal-wp-button-manager'); ?></div>
                    ...
                    <p>Save money on Visa/MasterCard/Discover transactions with a total fee of only 2.69% + 49¢','paypal-wp-button-manager'); ?></p><?php
                    if( isset( $redirect_url ) && is_wp_error( $redirect_url ) ){
                        ...
                        ?><a data-paypal-button="true" class="b-btn <?php echo isset( $redirect_url ) ? 'active' : ''; ?>" href="<?php echo isset( $redirect_url ) ? $redirect_url . '&displayMode=minibrowser' : 'javascript:void(0)'; ?>" target="PPFrame"><?php _e('Begin Now','paypal-wp-button-manager'); ?><img src="<?php echo WBP_IMAGE_PATH . 'arrow.png'; ?>"></a><?php
                    }
                ?></div>
