            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="company name">Choose Company Name:</label>
                        <div class="col-sm-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Step 1: Choose a button type and enter your payment details</a>
                                </h4>
                            </div>
                            <div id="collapse1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <section id="section_cartandbuynow">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="itemID" class="control-label">Item ID (optional)</label>
                                                    <input class="form-control" maxlength="127" type="text" id="itemID" size="9" name="product_id" value=""/>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label" for="itemPrice">Price</label>
                                                            <input class="form-control" type="text" id="itemPrice" size="9" name="item_price" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="control-label" for="itemPriceCurrency">Currency</label>
                                                ...
                                                <div class="form-group">                                                        
                                                    <h5>Shipping</h5>
                                                    <label for="itemFlatShippingAmount">Use specific amount: </label>
                                                    <div class="row">
                                                        <div class="col-sm-11">
                                                ...
                                                <div class="form-group">
                                                    <label for="itemTaxRate">Use tax rate </label> 
                                                    <div class="row">
                                                        <div class="col-sm-11">
                                    ...
                                    <div class="row">
                                      <section id="section_preview_box">
                                       <div class="col-sm-9">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">Customize button</div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                    <div id="customizeSection">
                                                        <div id="addDropdownPrice" class="hideShow opened">
                                                            <label class="control-label" for="dropdownPrice">
                                                                <input class="form-control" type="checkbox" id="dropdownPrice" name="dropdown_price" value="createdDropdownPrice">
                                                                <span class="products">&nbsp;&nbsp;Add drop-down menu with price/option&nbsp;</span>
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-12">
                                                        <div id="dropdownPriceSection" class="hide form-group">
                                                                    <label class="control-label" for="dropdownPriceTitle">
                                                                     <span class="products">Name of drop-down menu (ex.: "Colors," "Sizes")</span>                                                                     
                                                                    </label>
                                                                    <input class="form-control" maxlength="64" type="text" id="dropdownPriceTitle"  name="dropdown_price_title" value="">
                                                                  <div class="row">
                                                                   <div class="col-sm-5">
                                                                       <span class="products">Menu option name</span>
<!--                                                                               <span class="subscriptions accessAid fadedOut">Menu Name</span>-->
                                                                   </div>
                                                                   <div class="col-sm-4">
                                                                       <span class="products">Price</span>
<!--                                                                               <span class="subscriptions accessAid fadedOut">Amount (<span class="currencyLabel">USD</span>)</span>-->
                                                                   </div>
                                                                   <div class="col-sm-3">
                                                                       <span class="products">Currency</span>
<!--                                                                               <span class="subscriptions accessAid fadedOut">Frequency</span>-->
                                                                   </div>
                                                                  </div>
                                                            <div id="optionsPriceContainer">
                                                                <div class="row">
                                                                    <p class="optionRow"></p>
                                                                    <div class="col-sm-5">
                                                                        <input maxlength="64" type="text" class="ddpOptionName form-control" name="ddp_option_name" value="Option 1">
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" class="ddpOptionPrice form-control"  name="ddp_option_price" value="">
                                                                    </div>
                                                                    <div class="col-sm-3">
...
<!--                                                                            <select class="subscriptions ddpOptionFrequency" name="ddp_option_frequency" >
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-5">
                                                                        <input maxlength="64" type="text" class="ddpOptionName form-control"  name="ddp_option_name" value="Option 2">
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" class="ddpOptionPrice form-control"  name="ddp_option_price" value="">
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <label class="ddpOptionCurrency show" for="">USD</label>
                                                                    </div>
<!--                                                                            <select class="subscriptions ddpOptionFrequency accessAid fadedOut hide" name="ddp_option_frequency" >
                                                                            <?php foreach ($paypal_button_subscriptions as $paypal_button_subscriptions_key => $paypal_button_subscriptions_value) { ?>
                                                                                <option value="<?php echo $paypal_button_subscriptions_key; ?>"><?php echo $paypal_button_subscriptions_value; ?></option>
                                                                            <?php } ?>
                                                                    </select>-->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-5">
                                                                        <input maxlength="64" type="text" class="ddpOptionName form-control"  name="ddp_option_name" value="Option 3">
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" class="ddpOptionPrice form-control"  name="ddp_option_price" value="">
                                                                    </div>
...
<!--                                                                            <select class="subscriptions ddpOptionFrequency accessAid fadedOut hide" name="ddp_option_frequency" >
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <a id="addOptionPrice" class="btn btn-success"><span class="glyphicon glyphicon-plus-sign"></span></a>
                                                                    <a id="removeOptionPrice" class="btn btn-danger"><span class="glyphicon glyphicon-remove-sign"></span></a>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">                                                                    
                                                                     <button type="button" class="btn btn-primary" id="saveOptionPrice" name="save_option_price">Done</button> <button type="button" class="btn btn-danger" id="cancelOptionPrice">Cancel</button>                                                                    
                                                                </div>
                                                            </div>
                                                        </div>
                                                            </div>
                                                        ...
                                                        <div class="hideShow dropdownSection accessAid hide" id="dropdownSection1">
                                                            <p class="title"><label for="">Name of drop-down menu (ex.: "Colors," "Sizes")</label><input maxlength="64" type="text" class="dropdownTitle text"  name="dropdown1_title" value=""></p>
                                                            <p><label for="">Menu option name</label></p>
                                                            <div id="optionsContainer1">
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd1_option_name" value="Option 1"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd1_option_name" value="Option 2"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd1_option_name" value="Option 3"></p>
                                                            </div>
                                                        ...
                                                        <div class="hideShow dropdownSection accessAid hide" id="dropdownSection2">
                                                            <p class="title"><label for="">Name of drop-down menu (ex.: "Colors," "Sizes")</label><input maxlength="64" type="text" class="dropdownTitle text"  name="dropdown2_title" value=""></p>
                                                            <p><label for="">Menu option name</label></p>
                                                            <div id="optionsContainer2">
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd2_option_name" value="Option 1"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd2_option_name" value="Option 2"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd2_option_name" value="Option 3"></p>
                                                            </div>
                                                            <p class="moreOptionsLink"><a class="addOption" href="https://www.paypal.com/us/cgi-bin/webscr?cmd=">Add option</a></p>
                                                        ...
                                                        <div class="hideShow dropdownSection accessAid hide" id="dropdownSection3">
                                                            <p class="title"><label for="">Name of drop-down menu (ex.: "Colors," "Sizes")</label><input maxlength="64" type="text" class="dropdownTitle text"  name="dropdown3_title" value=""></p>
                                                            <p><label for="">Menu option name</label></p>
                                                            <div id="optionsContainer3">
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd3_option_name" value="Option 1"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd3_option_name" value="Option 2"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd3_option_name" value="Option 3"></p>
                                                            </div>
                                                            <p class="moreOptionsLink"><a class="addOption" href="https://www.paypal.com/us/cgi-bin/webscr?cmd=">Add option</a></p>
                                                        ...
                                                        <div class="hideShow dropdownSection accessAid hide" id="dropdownSection4">
                                                            <p class="title"><label for="">Name of drop-down menu (ex.: "Colors," "Sizes")</label><input maxlength="64" type="text" class="dropdownTitle text"  name="dropdown4_title" value=""></p>
                                                            <p><label for="">Menu option name</label></p>
                                                            <div id="optionsContainer4">
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd4_option_name" value="Option 1"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd4_option_name" value="Option 2"></p>
                                                                <p class="optionRow dropdown"><input maxlength="64" type="text" class="ddOptionName text"  name="dd4_option_name" value="Option 3"></p>
                                                            </div>
                                                            <p class="moreOptionsLink"><a class="addOption" href="https://www.paypal.com/us/cgi-bin/webscr?cmd=">Add option</a></p>
                                                        ...
                                                        <div class="hideShow accessAid textfieldSection hide" id="textfieldSection1">
                                                            <p class="title"><label for="textfieldTitle1">Enter name of text field (up to 30 characters)</label><input maxlength="30" type="text" id="textfieldTitle1" class="text"  name="textfield1_title" value=""></p>
                                                        ...
                                                        <div class="hideShow accessAid textfieldSection hide" id="textfieldSection2">
                                                            <p class="title"><label for="textfieldTitle2">Enter name of text field (up to 30 characters)</label><input maxlength="30" type="text" id="textfieldTitle2" class="text"  name="textfield2_title" value=""></p>
                                                            <p class="saveCancel"><input class="saveTextfield primary button" type="submit" name="save_textfield" value="Done" alt="Done"><a class="cancelTextfield" href="https://www.paypal.com/us/cgi-bin/webscr?cmd=">Cancel</a></p>
                                                        </div>
                                                        ...
                                                        <div id="buttonAppSection" class="hideShow accessAid hide">
                                                            ...
                                                            <div id="paypalButtonSection" class="hideShow opened">
                                                                ...
                                                                <p id="textSubscr" class="hideShow buttonText hide">
                                                                    <label for="">Select button text</label>
                                                                    <span class="field">
                                                                        <select id="buttonTextSubscribe" name="button_text" >
                                               ...
                                               <div class="col-sm-4">
                                                 <div class="buyerViewSection">
                                                    ...
                                                    <div class="previewSection">
                                                        ...
                                                        <p class="hideShow opened previewImageSection"><img id="previewImage" src="https://www.paypalobjects.com/webstatic/en_US/i/btn/png/btn_addtocart_120x26.png" border="0" alt="Preview Image"></p>
                                    ...
                                    <div class="col-sm-6">                                        
                                        <div class="group details">
                                            ...
                                            <div class="donations accessAid fadedOut">
                                                <div class="form-group">
                                                    <label for="donationName" class="control-label">Organization name/service</label>
                                                    <input class="form-control" maxlength="127" type="text" id="donationName" name="donation_name" value="" >
                                                </div>
                                                <div class="form-group">
                                                    <label for="donationID" class="control-label">Donation ID<span class="fieldNote"> (optional) </span></label>
                                                    <input class="form-control" maxlength="127" type="text" id="donationID" size="27" name="donation_id" value="" >
                                                </div>
                                            </div>
                                            <div class="subscriptions accessAid fadedOut">
                                                <div class="form-group">
                                                    <label for="subscriptionName" class="control-label">Item name</label>
                                                    <input class="form-control" maxlength="127" type="text" id="subscriptionName" name="subscription_name" value="" >
                                                </div>
                                                <div class="form-group">
                                                    <label for="subscriptionID" class="control-label">Subscription ID<span class="fieldNote"> (optional) </span>
                                                    </label><input class="form-control" maxlength="127" type="text" id="subscriptionID" size="27" name="subscription_id" value="" >
                                                </div>
                                            </div>
                                            <div class="gift_certs accessAid fadedOut">
                                                <label class="control-label" for="giftCertificateShopURL">Enter the URL where recipients can shop and redeem this gift certificate.</label>
                                                <input class="form-control" type="text" id="giftCertificateShopURL" size="34" name="gift_certificate_shop_url" value="http://" />
                                            </div>
                                        </div>                                        
                                        <div class="group subscriptions accessAid fadedOut form-group">
                                            <label for="subscriptionBillingAmountCurrency" class="control-label">Currency</label>
                                            <?php $paypal_button_currency = get_paypal_button_currency(); ?>
                                            <select id="subscriptionBillingAmountCurrency" name="item_price_currency" class="currencySelect form-control" >
                                                <?php foreach ($paypal_button_currency as $paypal_button_currency_key => $paypal_button_currency_value) { ?>
                                                    <option value="<?php echo $paypal_button_currency_value; ?>" title="<?php echo $paypal_button_options_key; ?>"><?php echo $paypal_button_currency_value; ?></option>
                                                <?php } ?>
                                            </select>
                                                ...
                                                <div class="group donations last accessAid fadedOut">
                                                    <div class="group donationCurrency">
                                                        ...
                                                        <select id="donationCurrency" name="item_price_currency" class="currencySelect" >
                                                            <?php foreach ($paypal_button_currency as $paypal_button_currency_key => $paypal_button_currency_value) { ?>
                                                                <option value="<?php echo $paypal_button_currency_value; ?>" title="<?php echo $paypal_button_options_key; ?>"><?php echo $paypal_button_currency_value; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="group contributionAmount">
                                                        <fieldset>
                                                            ...
                                                            <label for="optDonationTypeFlexible"><input class="radio donationType" type="radio" id="optDonationTypeFlexible" checked="" name="donation_type" value="open" >Donors enter their own contribution amount.</label>&nbsp;&nbsp;<label for="optDonationTypeFixed"><input class="radio donationType" type="radio" id="optDonationTypeFixed" name="donation_type" value="fixed" >Donors contribute a fixed amount.</label>
                                                            <div class="labelOption fixedDonationAmountContainer accessAid"><label for="fixedDonationAmount">Amount&nbsp;&nbsp;</label><input type="text" id="fixedDonationAmount" size="7" maxlength="20" class="text" name="item_price" value="" ><span class="currencyLabel">USD</span></div>
                                                        </fieldset>
                                                    </div>
                                                ...
                                                <div class="group subscriptions last accessAid fadedOut">
                                                    <div class="group">
                                                        <input type="checkbox" id="enableUsernamePasswordCreation" class="checkbox" name="enable_username_password_creation" value="1" >Have PayPal create user names and passwords for customers&nbsp;
                                                    ...
                                                    <div id="rbFixedAmount">
                                                        <div class="group"><label for="subscriptionBillingAmount">Billing amount each cycle</label><input type="text" id="subscriptionBillingAmount" size="22" class="text" name="subscription_billing_amount" value="" ><span class="currencyLabel">USD</span></div>
                                                        <div class="group">
                                                            ...
                                                            <select name="subscription_billing_cycle_number" >
                                                            ...
                                                            <select id="subscriptionBillingCyclePeriod" name="subscription_billing_cycle_period" >
                                                    ...
                                                    <div class="group">
                                                        ...
                                                        <select name="subscription_billing_limit" >
                                                            <?php
        ...
        <?php } ?>
                                                    ...
                                                    <div class="group">
                                                        <label for="offerTrial"><input type="checkbox" id="offerTrial" class="checkbox" name="subscriptions_offer_trial" value="1" >I want to offer a trial period</label>
                                                        <div class="trialOfferOptions accessAid">
                                                            <fieldset>
                                                                <legend>Amount to bill for the trial period
                                                                </legend>
                                                                <label for="subscriptionLowerRate">
                                                                    <input class="hidden" type="hidden" id="subscriptionLowerRate" name="subscription_trial_billing_amount" value="1" >
                                                                    <div><input type="text" id="subscriptionLowerRateAmount" size="11" class="text" name="subscription_trial_rate" value="" ><span class="currencyLabel">USD</span></div>
                                                                </label>
                                                            </fieldset>
                                                            <fieldset>
        <?php $paypal_button_subscription_trial_duration = get_paypal_button_subscription_trial_duration(); ?>
                                                                ...
                                                                <select name="subscription_trial_duration" >
        ...
        <?php } ?>
                                                                ...
                                                                <select id="trialDurationType" name="subscription_trial_duration_type" >
                                                                    <?php foreach ($paypal_button_subscriptions_cycle as $paypal_button_subscriptions_cycle_key => $paypal_button_subscriptions_cycle_value) { ?>
                                                                        <option value="<?php echo $paypal_button_subscriptions_cycle_key; ?>"><?php echo $paypal_button_subscriptions_cycle_value; ?></option>
        <?php } ?>
                                                                </select>
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <label for="secondSubscriptionTrialOffer"><input class="radio secondTrialOfferOption" type="radio" id="secondSubscriptionTrialOffer" name="subscriptions_offer_another_trial" value="1" >Yes</label>
                                                                <div class="secondTrialOfferOptions accessAid">
                                                                    <fieldset>
                                                                        <legend>Amount to bill for this trial period
                                                                        </legend>
                                                                        <div><input type="text" id="secondSubscriptionLowerRateAmount" size="11" class="text" name="subscription_trial_2_rate" value="" ><span class="currencyLabel">USD</span></div>
                                                                    </fieldset>
                                                                    <fieldset>
                                                                        <legend>How long should the trial period last?</legend>
                                                                        <select name="subscription_trial_2_duration" >
                                                                            <?php foreach ($paypal_button_subscription_trial_duration as $paypal_button_subscription_trial_duration_key => $paypal_button_subscription_trial_duration_value) { ?>
                                                                                <option value="<?php echo $paypal_button_subscription_trial_duration_key; ?>"><?php echo $paypal_button_subscription_trial_duration_value; ?></option>
        <?php } ?>
                                                                        </select>
                                                                        <select id="secondTrialDurationType" name="subscription_trial_2_duration_type" >
                                                                            <?php foreach ($paypal_button_subscriptions_cycle as $paypal_button_subscriptions_cycle_key => $paypal_button_subscriptions_cycle_value) { ?>
                                                                                <option value="<?php echo $paypal_button_subscriptions_cycle_key; ?>"><?php echo $paypal_button_subscriptions_cycle_value; ?></option>
        <?php } ?>
                                                                        </select>
                                                                ...
                                                                <label for="lastSubscriptionTrialOffer"><input class="radio secondTrialOfferOption" type="radio" id="lastSubscriptionTrialOffer" checked="" name="subscriptions_offer_another_trial" value="0" >No</label>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="group gift_certs last accessAid fadedOut">
                                                    <div class="group gcCurrency">
                                                        ...
                                                        <select id="gcAmountCurrency" name="item_price_currency" class="currencySelect" >
                                                            <?php foreach ($paypal_button_currency as $paypal_button_currency_key => $paypal_button_currency_value) { ?>
                                                                <option value="<?php echo $paypal_button_currency_value; ?>" title="<?php echo $paypal_button_options_key; ?>"><?php echo $paypal_button_currency_value; ?></option>
        <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="group">
                                                        <fieldset>
                                                            ...
                                                            <label for="gcAmountTypeList"><input class="radio gcAmountType" type="radio" id="gcAmountTypeList" checked="" name="gc_amount_type" value="custom" >Choose an amount from a preset list</label><label for="gcAmountTypeFixed"><input class="radio gcAmountType" type="radio" id="gcAmountTypeFixed" name="gc_amount_type" value="fixed" >Specify an amount of your choosing</label>
                                                            <div class="labelOption gcFixedAmountContainer accessAid"><label for="gcFixedAmount">Amount</label><input type="text" id="gcFixedAmount" size="9" class="text" name="gc_fixed_amount" value="" ><span class="currencyLabel">USD</span></div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="group">
                                                        <p class="gcStyleHeader_new"><strong>Gift certificate style</strong></p>
                                                        <label for="giftCertificateLogoURL">Add URL for logo image</label><input class="text" type="text" id="giftCertificateLogoURL" size="34" name="gc_logo_url" value="http://" >
                                                    </div>
                                                    <div class="group">
                                                        <fieldset>
                                                            <legend>Choose background</legend>
                                                            <label for="gcBackgroundColor">
                                                                <input class="radio gcBackgroundType" type="radio" checked="" name="gc_background_type" value="color" >Color
                                                                <div class="labelOption">
                                                                        <?php $paypal_button_gcBackgroundColor = get_paypal_button_gcBackgroundColor(); ?>
                                                                    <select id="gcBackgroundColor" name="gc_background_color" >
        ...
        <?php } ?>
                                                            ...
                                                            <label for="gcBackgroundTheme">
                                                                <input class="radio gcBackgroundType" type="radio" name="gc_background_type" value="theme" >Theme
                                                                <div class="labelOption">
                                                                        <?php $paypal_button_gcBackgroundTheme = get_paypal_button_gcBackgroundTheme(); ?>
                                                                    <select id="gcBackgroundTheme" name="gc_background_theme" >
        ...
        <?php } ?>
            ...
            wp_enqueue_script('button-admin-main-js', BMW_PLUGIN_URL . 'admin/js/paypal-wp-button-manager-admin-main.js', array(), '1.0', true);
        }
