...
class AngellEYE_PayPal_Button_Manager_for_WordPress_General_Setting {
    ...
    /**
     * paypal_button_manager_for_wordpress_general_setting function used for submit form of settings
     * @since 1.0.0
     * @access public
     */
    ...
    public static function paypal_button_manager_for_wordpress_general_setting_save_field() {
        ...
        if (isset($_POST['paypal_intigration'])):
            ...
            <div id="setting-error-settings_updated" class="updated settings-error"> 
                <p><?php echo '<strong>' . __('Settings were saved successfully.', 'paypal-button-manager-for-wordpress') . '</strong>'; ?></p></div>
